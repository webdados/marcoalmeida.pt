...
(async function() {
  const availableThemes = ['bulky', 'kubrik', 'bright', 'dark', 'minimal', 'dark-marcoalmeida'];
...
async function initializeContent() {
  try {
    ...
    const socialIconMap = {
      ...
      instagram: `<svg class="social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M12,2.163c3.313,0,3.688,0,4.986.072c1.3.072,2.08.298,2.57.628c.5.34,.855,.795,1.195,1.195c.33,.49,.556,1.27,.628,2.57C21.837,8.312,22.212,8.687,22.212,12s-.375,3.688-.072,4.986c-.072,1.3-.298,2.08-.628,2.57c-.34,.5-.795,.855-1.195,1.195c-.49,.33-1.27,.556-2.57,.628C15.688,21.837,15.313,22,12,22s-3.688-.163-4.986-.072c-1.3-.072-2.08-.298-2.57-.628c-.5-.34-.855-.795-1.195-1.195c-.33-.49-.556-1.27-.628-2.57C2.163,15.688,2,15.313,2,12s0-3 .163-4 .298-2 .628-2 .855-1 .195-1 .34-1 .5-1 .5Z"></path><path d="M12 6a6 6 0 1 0 6 6a6 6 0 0 0 -6 -6Zm0 10a4 4 0 1 1 4 -4a4 4 0 0 1 -4 4Z"></path><circle cx="17" cy="7" r=".5"></circle></svg>`,
